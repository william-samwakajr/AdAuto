            ...
            <div class="conatiner flex-1 gap-10 justify-center flex mt-8  px-4">
                                    ...
                                    <div class="card-body items-center text-center">
                                        ...
                                        <div class="card-actions">
                                           <form method="GET" action="/login">
                                             <button class="btn btn-primary"> Select Local Stuff</button>
                                         </form>
                                        </div>
                                    </div>
                            </div>
                            <div class="card bg-base-100 w-96 shadow-sm">
                                    ...
                                    <div class="card-body items-center text-center">
                                        ...
                                        <div class="card-actions">
                                         <form method="GET" action="/login">
                                             <button class="btn btn-primary">Select Manager</button>
                                         </form>
                                        </div>
                                    </div>
                            </div>
                                    ...
                                    <div class="card-body items-center text-center">
                                        ...
                                        <div class="card-actions">
                                         <form method="GET" action="/register">
                                             <button class="btn btn-primary">Select Warehouse</button>
                                         </form>
                                        </div>
                                    </div>
                            </div>
